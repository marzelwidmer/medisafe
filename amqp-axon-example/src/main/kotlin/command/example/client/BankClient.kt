...
package command.example.client

import mu.KLogging
import org.axonframework.commandhandling.gateway.CommandGateway
import command.example.api.AccountBalanceQuery
import command.example.api.CreateBankAccountCommand
import command.example.api.DepositMoneyCommand
...
class BankClient(
    ...
    fun balance() {
        val amount = queryGateway.query(
            "command.example.api.AccountBalanceQuery",
            AccountBalanceQuery(
                bankAccountId = accountId
            ),
